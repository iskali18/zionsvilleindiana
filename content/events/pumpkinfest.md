...
endDate: "2026-10-03"
startDateTime: "2026-10-03T12:00:00-04:00"
endDateTime: "2026-10-03T16:00:00-04:00"
...
image: /images/events/pumpkinfest-zionsville.webp
imageAlt: "Pumpkins scattered across a grassy field during Pumpkinfest in Zionsville, with a tractor and hay wagon in the background."
...
faqs:
  ...
  - q: "Where is Pumpkinfest held?"
    a: "Pumpkinfest is at St. Alphonsus Liguori Catholic Church, 1870 W. Oak Street, Zionsville."
...
St. Alphonsus Liguori Catholic Church hosts Pumpkinfest on Saturday, October 3, 2026, from noon to 4:00 p.m. Open to the public and all ages, the afternoon includes a hayride to the pumpkin patch and family activities across the parish grounds.
...
<figure className="my-8">
  <Image
    src="/images/events/pumpkinfest-pumpkin-patch.webp"
    alt="Bright orange pumpkins arranged across a green grass field backed by a dense line of evergreen trees in Zionsville, Indiana."
    width={1800}
    height={1200}
    className="w-full h-auto rounded"
  />
  <figcaption className="text-sm text-stone-600 italic mt-2">
    Pumpkins set out across the church field during Pumpkinfest at St. Alphonsus Liguori Catholic Church in Zionsville. <br /> <span className="not-italic">© ZionsvilleIndiana.com</span>
  </figcaption>
</figure>
...
<figure className="my-8">
  <Image
    src="/images/events/pumpkinfest-decorating-tables.webp"
    alt="Outdoor pumpkin decorating station set under shade trees with long tables holding paint bottles, brushes, chairs, and a smaller display table on the right with painted pumpkins drying."
    width={1800}
    height={1200}
    className="w-full h-auto rounded"
  />
  <figcaption className="text-sm text-stone-600 italic mt-2">
    Pumpkin decorating tables and paint stations set up for families during Pumpkinfest in Zionsville. <br /> <span className="not-italic">© ZionsvilleIndiana.com</span>
  </figcaption>
</figure>
