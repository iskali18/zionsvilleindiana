...
itemList:
  ...
  - name: "Graham Rahal Performance Trunk or Treat"
    href: "#graham-rahal-performance-trunk-or-treat"
    description: "Saturday, October 24, 4–6 p.m. at Graham Rahal Performance during the final Cars & Coffee of the season."
  - name: "Eagle Church Trunk or Treat"
    href: "#eagle-church-trunk-or-treat"
    description: "Saturday, October 24, 4–6 p.m. at Eagle Church. Pumpkin decorating, hayrides, cider and donut holes."
...
ctas:
  - label: "See all Zionsville events"
    href: "/events"
  - label: "Find a pumpkin patch or corn maze"
...
Children follow the Trick-or-Treat Trail through Elm Street Green and collect treats from participating businesses and organizations. The morning also includes marshmallow roasting around the firepit, hands-on fall activities, science experiments, games, the Pumpkin Path and scarecrows decorated by local businesses and organizations.

### Registration

Each participating child must be registered for a timed entry. Entry times are offered in 30-minute windows beginning at 9 AM, with the final entry beginning at 11 AM and the last check-in at 11:30 AM.
...
The Trunk or Treat closes out the Cars & Coffee season. The Humane Society for Boone County will be there with dogs and puppies available for adoption.

See [Graham Rahal Performance on Instagram](https://www.instagram.com/grahamrahalperformance/) for the latest details.
