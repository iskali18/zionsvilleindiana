...
export const EVENTS: ChristmasEvent[] = [
  ...
  {
    name: 'Back to Bethlehem (Walk-Through Christmas Story)',
    anchor: 'back-to-bethlehem-walk-through-christmas-story',
    dates: ['2026-12-13'],
    types: ['Family', 'Church'],
    admission: 'ticketed',
    time: '5:30\u20138:30 p.m.',
  ...
  {
    name: 'An Afternoon with Santa',
    anchor: 'an-afternoon-with-santa',
    dates: ['2026-12-13'],
    types: ['Family'],
    admission: 'ticketed',
    time: 'noon\u20134:00 p.m.',
    organizer: 'Morning Dove Therapeutic Riding Center',
    venue: 'The Red Barn at Traders Point Creamery',
    summary: 'Visits with Santa, cookie and ornament decorating, face painting and a hot chocolate bar',
  },
  {
    name: 'The Bethlehem Beat (Children\u2019s Musical)',
    anchor: 'the-bethlehem-beat-childrens-musical',
    dates: ['2026-12-13'],
    types: ['Family', 'Concerts & Performances', 'Church'],
    admission: 'free',
    time: 'time to be announced',
    venue: 'Zionsville United Methodist Church',
    summary: 'Children\u2019s Christmas musical with a playful take on the Nativity story, including rapping shepherds',
  },
  {
