...
export const FALL_ACTIVITIES: FallActivity[] = [
  ...
  },
  {
    ...
    when: 'Sept. 26',
    sortDate: '2026-09-26',
    what: 'Live music from The Janeways and The Flying Toasters on Main Street in downtown Zionsville',
  ...
  },
  {
    ...
    when: 'Sept. 17',
    sortDate: '2026-09-17',
    what: 'Eighties music, fashion and throwback fun at local shops along Main Street',
    types: ['Downtown'],
    free: true,
    featured: 80,
  },
  ...
  },
  {
    ...
    when: 'Sept. 19 & 26',
    sortDate: '2026-09-19',
    what: 'Outdoor movies projected onto the barn at Maplelawn Farmstead',
  ...
  {
    name: 'Fall Programs in Zionsville Parks',
    anchor: 'experience-fall-with-zionsville-parks--recreation',
    when: 'Sept. 17\u2013Nov. 21',
    sortDate: '2026-09-17',
    what: 'Guided birding, live music, night hikes, owl walks and campfires in Zionsville parks',
    types: ['Family', 'Outdoors'],
    free: false,
    featured: 140,
  },
  {
    ...
    sortDate: '2026-09-12',
    what: 'Saturday mornings with local produce, food vendors and live music',
    types: ['Family', 'Outdoors', 'Downtown'],
    free: true,
    featured: 150,
  },
